...
export const environment = {
  ...
  firebaseConfig: {
    ...
    databaseURL: "https://matchmyhome-7054f-default-rtdb.europe-west1.firebasedatabase.app",
  ...
  gold: [{
    id: 'refresh',
    mainHeader: 'Get match my home Gold',
    icon: 'heart',
  ...
  star: [{
    id: 'star',
    mainHeader: 'Get Match My Home Plus',
  ...
  images: [{ image: '../../assets/chat/chat1.jpg' },
  ...
  card: [
    ...
    },
    {
      ...
      slides: [
        { slideImage: '../../assets/chat/house2.jpg' },
        { slideImage: '../../assets/chat/house.png' }
    ...
    },
    {
      name: 'House',
      symbol: 'IIIME',
      image: '../../assets/chat/house.png',
      price: '26 0000',
      distance: 'less than 3 mile away',
      bathrooms: '2',
      rooms: '3',
      property:{'1': 'House', '2':'Apartaments'},
  ...
  details: [{
    userDetails: 'A BITS and IIT Delhi alumni established web and mobile development product and service providing company located at jaipur and bangalore.',
    image: '../../assets/chat/chat1.jpg',
    ovalContents: [{
      icon: 'settings',
      text: 'SETTINGS',
